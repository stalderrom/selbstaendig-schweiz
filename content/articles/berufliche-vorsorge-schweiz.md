...
keywords:
  ...
  - bvg beiträge 2026
  - berufliche vorsorge selbständige
  - pensionskasse kmu
  - bvg pflicht arbeitgeber
category: versicherungen
author: Redaktion
publishedAt: '2026-03-19'
updatedAt: '2026-03-19'
slug: berufliche-vorsorge-schweiz
readingTime: 12
howto:
  name: 'BVG-Pflicht als KMU-Gründer erfüllen – Schritt für Schritt 2026'
  description: 'So melden Sie Ihre Mitarbeitenden korrekt bei einer Pensionskasse an – und vermeiden teure Fehler bei der BVG-Pflicht.'
  totalTime: 'P14D'
  steps:
    - name: 'Versicherungspflicht prüfen'
      text: 'Prüfen Sie für jeden Mitarbeitenden: Jahreslohn > CHF 22''050 (Eintrittsschwelle 2026)? Alter ≥ 17 Jahre? Befristung > 3 Monate? Bei Ja zu allen drei → BVG-Pflicht. Ausnahme: Selbständige, Familienmitglieder ohne Lohn, geringfügig Beschäftigte.'
      url: 'https://selbstaendig-schweiz.ch/artikel/berufliche-vorsorge-schweiz#bvg-versicherungspflicht'
    - name: 'Pensionskasse auswählen'
      text: 'Holen Sie mindestens 3 Offerten ein (Sammelstiftungen wie Helvetia, Swiss Life, Baloise, PKG oder branchenspezifische Kassen). Achten Sie auf: Deckungsgrad (sollte >100%), Verwaltungskosten (0.3–1.5% des Vorsorgevermögens), Umwandlungssatz und Leistungen bei Invalidität/Tod.'
      url: 'https://selbstaendig-schweiz.ch/artikel/berufliche-vorsorge-schweiz#pensionskasse-waehlen'
    - name: 'Anschlussvertrag unterzeichnen'
      text: 'Unterzeichnen Sie den Anschlussvertrag mit der gewählten Pensionskasse spätestens am ersten Arbeitstag des ersten BVG-pflichtigen Mitarbeitenden. Rückwirkende Anschlüsse sind möglich, aber kostspieliger. Ohne Anschluss greift die Auffangeinrichtung BVG automatisch – zu Standardkonditionen ohne Wahlmöglichkeit.'
      url: 'https://selbstaendig-schweiz.ch/artikel/berufliche-vorsorge-schweiz#bvg-kmu-pflicht'
    - name: 'Mitarbeitende anmelden und Beiträge abrechnen'
      text: 'Melden Sie jeden versicherungspflichtigen Mitarbeitenden mit Lohn, Alter und Eintrittsdatum an. Zahlen Sie Arbeitnehmer- und Arbeitgeberanteil zusammen mit dem Lohn ab (monatlich oder quartalsweise). Beide Anteile sind lohnabhängig: Der Arbeitgeber muss mindestens 50% der Gesamtprämie übernehmen (BVG Art. 66).'
      url: 'https://selbstaendig-schweiz.ch/artikel/berufliche-vorsorge-schweiz#bvg-beitraege-2026'
    - name: 'Vorsorgeausweis ausstellen und kommunizieren'
      text: 'Die Pensionskasse stellt jedem Versicherten jährlich einen Vorsorgeausweis aus. Erklären Sie Ihren Mitarbeitenden die wichtigsten Kennzahlen: angesparte Altersguthaben, versicherter Lohn, Todes- und Invaliditätsleistungen. Bei Kaderleistungen (überobligatorischer Teil) auf Unterschiede zum Obligatorium hinweisen.'
      url: 'https://selbstaendig-schweiz.ch/artikel/berufliche-vorsorge-schweiz#vorsorgeausweis'
faq:
  - question: 'Was ist berufliche Vorsorge (BVG) in der Schweiz?'
    answer: >-
      Die berufliche Vorsorge (BVG) ist die 2. Säule des Schweizer Drei-Säulen-Systems.
      Sie ergänzt die AHV und soll zusammen mit ihr die Fortsetzung des gewohnten
      Lebensstandards im Alter sichern. Das BVG (Bundesgesetz über die berufliche Alters-,
      Hinterlassenen- und Invalidenvorsorge) ist seit 1985 in Kraft. Arbeitgeber sind
      verpflichtet, ihre Mitarbeitenden bei einer Pensionskasse anzumelden (ab CHF 22'050
      Jahreslohn, 2026). Arbeitgeber und Arbeitnehmer teilen die Beiträge – der Arbeitgeber
      muss mindestens 50% der Gesamtprämie tragen (BVG Art. 66).
  - question: 'Ab wann müssen Mitarbeitende in der Schweiz BVG-versichert sein?'
    answer: >-
      Versicherungspflicht besteht ab: (1) Jahreslohn > CHF 22'050 (Eintrittsschwelle 2026),
      (2) Alter ≥ 17 Jahre (für Risikoleistungen ab 17, für Altersguthaben ab 25),
      (3) Beschäftigung > 3 Monate beim gleichen Arbeitgeber. Wer unter der Eintrittsschwelle
      verdient oder mehrere Teilzeitstellen hat, kann sich unter Umständen freiwillig
      versichern lassen.
  - question: 'Wie hoch sind die BVG-Beiträge 2026?'
    answer: >-
      BVG-Sparbeiträge 2026 in % des koordinierten Lohns: 25–34 Jahre: 7% (je 3.5% AG+AN),
      35–44 Jahre: 10% (je 5%), 45–54 Jahre: 15% (je 7.5%), 55–65 Jahre: 18% (je 9%).
      Koordinierter Lohn = Bruttolohn minus Koordinationsabzug CHF 25'725, maximal CHF 62'475.
      Der Arbeitgeber trägt mindestens 50% = mind. denselben Betrag wie der Arbeitnehmer.
  - question: 'Muss ich als Selbständiger (Einzelfirma) in die Pensionskasse einzahlen?'
    answer: >-
      Nein – Selbständige sind nicht BVG-pflichtig. Sie können freiwillig einer
      Sammelstiftung beitreten (Verbandspenionskasse oder Auffangeinrichtung BVG).
      Alternativ: Säule 3a bis CHF 36'288/Jahr (2026, ~20% des Nettoeinkommens) – steuerlich
      voll abzugsfähig und flexibler als eine PK. Für Einkommen über CHF 150'000/Jahr
      kann die freiwillige PK steuerlich vorteilhafter sein.
  - question: 'Was passiert wenn ich als Arbeitgeber keine Pensionskasse abschliesse?'
    answer: >-
      Ohne BVG-Anschluss greift die Auffangeinrichtung BVG automatisch (BVG Art. 11/12).
      Sie schreibt Ihnen einen Anschluss zu – zu Standardkonditionen ohne Verhandlungsmöglichkeit.
      Zusätzlich haften Sie für entgangene Leistungen rückwirkend. Strafrechtlich: Bussen
      nach BVG Art. 76. Praxis: Die Auffangeinrichtung ist teurer als ein regulärer Anschluss.
      Bei verspätetem Beitritt fallen Verzugszinsen auf Nachzahlungen an.
  - question: 'Wie wechsle ich als KMU die Pensionskasse?'
    answer: >-
      Kündigung: bis 30. Juni für den Jahreswechsel per 31. Dezember (6 Monate Frist, BVG-Recht).
      Schritte: (1) Deckungsgrad und Kosten aktuelle PK prüfen, (2) Offerten einholen
      (mind. 3, bis April/Mai), (3) Entscheid und neuen Anschlussvertrag unterzeichnen (bis Juni),
      (4) Kündigung alte PK schriftlich per 30. Juni, (5) Mitarbeitende min. 3 Monate vor
      Wechsel informieren. Wichtig: Austrittsleistungen (FZL) werden übertragen – kein Verlust
      für Mitarbeitende.
  - question: 'Was ist der Unterschied zwischen obligatorischer und überobligatorischer Vorsorge (BVG)?'
    answer: >-
      Obligatorium: Das gesetzliche Minimum nach BVG. Lohn CHF 25'725–88'200, Sparsätze 7–18%,
      Mindestzins 1.25% (2026), Umwandlungssatz 6.8%. Überobligatorium: Freiwillige Leistungen
      der PK über das Minimum hinaus. Viele PKs versichern Löhne bis CHF 200'000+. Der
      Umwandlungssatz im Überobligatorium liegt oft bei 5.0–5.8% – deutlich tiefer als im
      Obligatorium. Kadermitarbeitende: immer prüfen, wie gross der überobligatorische Anteil ist.
  - question: 'Was zeigt der Vorsorgeausweis der Pensionskasse?'
    answer: >-
      Der jährliche Vorsorgeausweis zeigt: (1) Angesparte Altersguthaben (Obligatorium +
      Überobligatorium), (2) Voraussichtliche Altersrente und -kapital bei Pensionierung,
      (3) Versicherter Lohn (koordinierter Lohn), (4) Invalidenleistungen (Rente bei
      Erwerbsunfähigkeit), (5) Todesfallleistungen (Witwen-/Witwerrente, Waisenrente).
      Kontrolle: Stimmt der versicherte Lohn? Ist die Beitragsaufteilung korrekt?
---
...
1. **Jahreslohn > CHF 22'050** (Eintrittsschwelle 2026, BVG Art. 7 Abs. 1)
2. **Alter ≥ 17 Jahre** (Risikoleistungen ab 17, Alterssparen ab 25)
3. **Anstellung > 3 Monate** beim gleichen Arbeitgeber (bei befristeten Stellen: Summe der Einsätze beim gleichen AG)
...
*Mehr dazu: [Altersvorsorge für Selbständige](/artikel/altersvorsorge-selbststaendige)*
