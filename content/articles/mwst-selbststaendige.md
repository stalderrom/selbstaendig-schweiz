...
faq:
  - question: Ab wann muss ich MWST abrechnen?
    answer: >-
      MWST-Pflicht entsteht ab CHF 100'000 Jahresumsatz im Inland (obligatorisch). Darunter kannst du dich freiwillig anmelden, was sich lohnt wenn du hohe Ausgaben mit MWST hast (z.B. Büro, Equipment). Freiwillige Anmeldung ist ab CHF 10'000 Umsatz möglich. Neu gegründete Unternehmen müssen sich anmelden, wenn der voraussichtliche Umsatz CHF 100'000 übersteigen wird.
  - question: Welche MWST-Methode ist besser – effektiv oder Saldosteuersatz?
    answer: >-
      Effektive Methode ist besser bei hohen Geschäftsausgaben mit MWST (Büro, Equipment, Wareneinkauf). Saldosteuersatz ist einfacher und günstiger bei wenig Ausgaben (reine Dienstleister ohne viel Einkauf). Faustregel: Sind deine Vorsteuer-Abzüge höher als der Saldosteuersatz ergibt, wähle effektiv. Lasse dich von einem Treuhänder beraten.
  - question: Was passiert wenn ich die MWST zu spät anmelde?
    answer: >-
      Du musst die Steuer rückwirkend nachzahlen – oft inklusive Verzugszinsen von 4.5% pro Jahr. Zusätzlich droht eine Busse. Die ESTV prüft regelmässig und findet Verstösse schnell über AHV-Meldungen und Bankdaten. Melde dich daher rechtzeitig an, sobald du erkennst, dass du die CHF 100'000 überschreiten wirst.
  - question: Kann ich die MWST von Privatkunden kassieren?
    answer: >-
      Ja – du stellst die Rechnung mit MWST aus (z.B. CHF 1'000 + CHF 77 MWST = CHF 1'077). Bei Privatkunden erhöht MWST den Preis, da sie keinen Vorsteuerabzug haben. Bei B2B-Kunden ist MWST neutral, da sie Vorsteuer zurückfordern können. Überlege daher, ob deine Kunden hauptsächlich Privat oder Firmen sind.
---

# MWST für Selbständige in der Schweiz 2026: Alles was du wissen musst
...
→ Prüfe auf der [ESTV-Website](https://www.estv.admin.ch) ob deine Tätigkeit ausgenommen ist.
...
→ [Professionelle Rechnungsvorlagen Schweiz](/artikel/rechnungsvorlage-schweiz)
...
**Gemischte Verwendung (z.B. Privatfahrzeug):**
Nur der geschäftliche Anteil ist abziehbar (z.B. 60% bei 60% geschäftlicher Nutzung).
...
→ Mehr dazu: [Buchhaltung für Selbständige](/artikel/buchhaltung-selbststaendige)
...
- [Rechnungsvorlage Schweiz](/artikel/rechnungsvorlage-schweiz)
