---
title: "Liquiditätsplanung Selbständige Schweiz 2026: Vorlage & Tipps"
metaTitle: 'Liquiditätsplanung Selbständige Schweiz 2026: Vorlage'
description: "Liquiditätsplanung für Selbständige in der Schweiz: Wie planst du deinen Cashflow, vermeidest Zahlungsengpässe und sicherst die Liquidität? 2026 mit Vorlage."
keywords:
  - liquiditätsplanung selbständige schweiz
  - cashflow planung selbständige schweiz
  - liquidität sichern selbständige schweiz
  - finanzplanung selbständige schweiz
  - zahlungsengpass vermeiden schweiz
category: finanzen
author: Redaktion
publishedAt: '2026-03-28'
slug: liquiditaetsplanung-selbstaendige-schweiz
faq:
  - question: Wie viel Liquiditätsreserve brauche ich als Selbständiger in der Schweiz?
    answer: >-
      Faustregel: Mindestens 3 Monate, besser 6 Monate Fixkosten als Liquiditätspuffer.
      Fixkosten bei typischem Einzelselbständigen: CHF 3'000–8'000/Monat (Miete, AHV-Akontos,
      Versicherungen, Software, Lebenshaltung). Empfohlener Puffer: CHF 15'000–50'000.
      In den ersten 2 Jahren Selbständigkeit solltest du 6–12 Monate Reserve haben –
      die Einnahmen sind anfangs unregelmässig.
  - question: Was ist ein Liquiditätsplan und wie erstelle ich ihn?
    answer: >-
      Ein Liquiditätsplan ist eine monatliche Vorschau auf Einnahmen und Ausgaben, die zeigt,
      wann Geld reinkommt und wann Rechnungen bezahlt werden müssen. Er beantwortet: Kann ich
      im Monat X alle Ausgaben bezahlen? Erstellung: (1) Liste aller fixen monatlichen Ausgaben.
      (2) Schätze variable Einnahmen nach Monat. (3) Berechne den Saldo (Einnahmen - Ausgaben).
      (4) Schau voraus: Wann entstehen Liquiditätslücken?
  - question: Wie vermeide ich Zahlungsengpässe als Selbständiger?
    answer: >-
      5 wichtige Massnahmen: (1) Anzahlungen verlangen (30–50% bei Projektstart).
      (2) Kurze Zahlungsfristen setzen (10–20 Tage statt 30–60).
      (3) Mahnwesen proaktiv einsetzen (nach 5 Tagen Verzug mahnen).
      (4) AHV-Akontos und Steuern monatlich reservieren (15–20% des Umsatzes).
      (5) Kontokorrentlimit als Sicherheitsnetz bei der Bank verhandeln.
  - question: Wie plane ich AHV und Steuern in der Liquidität ein?
    answer: >-
      Faustregel: Lege monatlich 20–25% deines Nettoumsatzes zurück für AHV (ca. 12%) und
      Einkommenssteuer (ca. 8–15% je nach Kanton und Einkommen). Erstelle ein separates
      "Steuer-Konto" und überweise diesen Betrag am Monatsende automatisch. So vermeidest du
      die böse Überraschung, wenn AHV-Schlussabrechnungen und Steuerbescheide eintreffen.
---

# Liquiditätsplanung für Selbständige Schweiz 2026
...
**Methode 1: Projektbasiert**
Liste alle bekannten und wahrscheinlichen Projekte für die nächsten 6 Monate auf. Verteile die Zahlungen auf die Monate, in denen du sie realistisch erwartest (nicht wann du fakturierst, sondern wann du inkassierst!).
...
→ Eröffne ein separates Sparkonto "Steuern & AHV"
→ Überweise am Monatsletzten automatisch den Prozentsatz deines Umsatzes
→ Dieses Konto NICHT anfassen ausser für Steuer-/AHV-Zahlungen
...
| Tool | Nutzung | Kosten |
|---|---|---|
| [Bexio](/go/bexio) | Debitoren, Mahnwesen, Bankabgleich | Ab CHF 29/Monat |
...
- [Break-even Rechner Schweiz](/artikel/break-even-rechner-schweiz)
- [Betreibung Schweiz Selbständige](/artikel/betreibung-schweiz-selbstaendige)
- [Bankkredit Selbständige Schweiz](/artikel/bankkredit-selbststaendige-schweiz)
