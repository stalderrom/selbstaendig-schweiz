...
keywords:
  ...
  - mehrwertsteuer anmelden schweiz
  - mwst normalsatz schweiz 2026
  - schweiz mehrwertsteuer normalsatz 2026 8.1%
...
slug: mwst-anmeldung-schweiz
faq:
  - question: "Wie hoch ist der MWST Normalsatz Schweiz 2026?"
    answer: "Der Normalsatz beträgt 8.1% (seit 1. Januar 2024). Daneben gibt es den Sondersatz für Beherbergung 3.8% und den reduzierten Satz 2.6% (Lebensmittel, Medikamente, Bücher, Zeitungen)."
  - question: "Ab wann muss ich mich für die MWST anmelden?"
    answer: "Die Anmeldepflicht entsteht ab CHF 100'000 Jahresumsatz aus steuerbaren Leistungen im Inland. Bei Neugründung: Wenn du voraussichtlich CHF 100'000 überschreiten wirst, musst du dich vor Beginn der Tätigkeit anmelden."
  - question: "Wie melde ich mich für die MWST an?"
    answer: "Online unter mwst.estv.admin.ch – Formular 'Antrag auf Eintragung ins MWST-Register'. Du brauchst: UID-Nummer, Bankverbindung, voraussichtlicher Umsatz, gewählte Abrechnungsmethode. Die ESTV bestätigt die Eintragung innert 2-4 Wochen."
  - question: "Lohnt sich die freiwillige MWST-Anmeldung?"
    answer: "Ja, wenn deine Vorsteuer (MWST auf Einkäufe) hoch ist – z.B. bei teurem Equipment, Büroräumlichkeiten oder Wareneinkauf. Beispiel: Du kaufst für CHF 50'000 Equipment (CHF 4'050 MWST) und hast nur CHF 60'000 Umsatz – freiwillige Anmeldung erlaubt die Vorsteuer-Rückforderung."
  - question: "Was ist der Unterschied effektive Methode vs. Saldosteuersatz?"
    answer: "Effektive Methode: Du rechnest jede einzelne Steuer und Vorsteuer ab. Aufwändiger, aber günstiger bei hohen Ausgaben. Saldosteuersatz: Vereinfachte Abrechnung mit einem Pauschalsatz je nach Branche (1.2–6.5%). Weniger Aufwand, meist höhere effektive Steuer. Abrechnung nur 2x/Jahr."
howto:
  name: "MWST anmelden Schweiz 2026"
  description: "Schritt-für-Schritt Anmeldung bei der ESTV für die Mehrwertsteuer."
  totalTime: "P7D"
  steps:
    - name: "UID-Nummer beschaffen"
      text: "Falls noch nicht vorhanden: UID beantragen unter uid.admin.ch (kostenlos, sofort). Die UID ist deine eindeutige Unternehmens-Identifikationsnummer – ohne sie keine MWST-Anmeldung."
    - name: "Abrechnungsmethode wählen"
      text: "Entscheide dich für effektive Methode oder Saldosteuersatz. Bei Unsicherheit: Treuhänder konsultieren. Die Wahl kann nur einmal pro Jahr geändert werden."
    - name: "Online-Anmeldung ESTV"
      text: "Gehe auf mwst.estv.admin.ch → 'Anmelden' → 'Eintragung ins MWST-Register beantragen'. Fülle alle Felder aus: Unternehmensform, voraussichtlicher Umsatz, Abrechnungsperiode (vierteljährlich oder halbjährlich bei Saldosteuersatz)."
    - name: "Bestätigung abwarten"
      text: "Die ESTV prüft deinen Antrag und sendet die MWST-Nummer (Format: CHE-XXX.XXX.XXX MWST) innert 2-4 Wochen. Ab diesem Datum bist du steuerpflichtig."
    - name: "Buchhaltung anpassen"
      text: "Passe deine Rechnungsvorlagen an: MWST-Nummer, Steuersatz und Steuerbetrag müssen auf jeder Rechnung aufgeführt sein. Trenne in der Buchhaltung klar zwischen Nettobetrag und MWST."
---

# MWST Anmeldung Schweiz 2026: Schritt-für-Schritt Guide
...
Mehr zur Rechnungsstellung: [Rechnungsvorlage Schweiz](/artikel/rechnungsvorlage-schweiz).
...
- 2. Halbjahr: Abgabe bis 28. Februar des Folgejahres
...
Mehr zur [MWST für Selbständige im Detail](/artikel/mwst-selbststaendige).
