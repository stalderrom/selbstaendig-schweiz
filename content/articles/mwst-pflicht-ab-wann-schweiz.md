---
title: "MWST-Pflicht Schweiz: Ab wann, wie anmelden & was du wissen musst (2026)"
metaTitle: 'MWST-Pflicht Schweiz 2026: Ab wann bist du dabei?'
description: 'MWST-Pflicht Schweiz: Ab CHF 100.000 Umsatz bist du dabei. Wie du dich anmeldest, welche Ausnahmen es gibt und was der Saldosteuersatz bedeutet.'
keywords: ["mwst pflicht schweiz", "mwst pflicht ab wann", "mwst anmeldung schweiz", "mehrwertsteuer pflicht selbständige schweiz", "mwst grenze schweiz"]
category: "steuern"
author: "Redaktion"
publishedAt: "2026-03-26"
slug: "mwst-pflicht-ab-wann-schweiz"
faq:
  - question: Ab wann bin ich in der Schweiz MWST-pflichtig?
    answer: >-
      Du bist MWST-pflichtig, sobald dein Jahresumsatz CHF 100.000 überschreitet oder voraussichtlich überschreiten wird. Dieser Wert gilt weltweit – also inklusive Umsatz mit ausländischen Kunden. Darunter bist du von der MWST befreit, kannst dich aber freiwillig anmelden.
  - question: Was passiert wenn ich die MWST-Anmeldung vergesse?
    answer: >-
      Das kann teuer werden. Die ESTV kann rückwirkend MWST plus Verzugszinsen einfordern. Ausserdem riskierst du eine Busse. Wenn du merkst, dass du die CHF 100.000-Grenze überschreitest, melde dich sofort an – innerhalb von 30 Tagen.
  - question: Kann ich mich freiwillig für die MWST anmelden?
    answer: >-
      Ja. Du kannst dich schon ab CHF 10.000 Jahresumsatz freiwillig für die MWST anmelden. Das lohnt sich wenn du hohe Ausgaben mit MWST hast (z.B. teures Equipment), denn dann kannst du die Vorsteuer zurückholen.
  - question: Was ist der Unterschied zwischen Saldosteuersatz und effektiver Methode?
    answer: >-
      Mit der effektiven Methode rechnest du jede MWST-Transaktion einzeln ab – genauer aber aufwändiger. Mit dem Saldosteuersatz zahlst du einen vereinfachten Prozentsatz auf deinen Umsatz – weniger Aufwand, aber manchmal etwas mehr oder weniger Steuer. Für kleine Betriebe unter CHF 5 Millionen oft einfacher.
  - question: Welche Tätigkeiten sind von der MWST ausgenommen?
    answer: >-
      Einige Tätigkeiten sind komplett von der MWST ausgenommen (nicht nur befreit): Ärztliche Leistungen, Bildung (Schulen, Nachhilfe), Wohnungsvermietung, Soziale Einrichtungen und einige Versicherungsleistungen. Wenn du in diesen Bereichen tätig bist, schuldest du keine MWST – kannst aber auch keine Vorsteuer zurückholen.
  - question: Wie melde ich mich für die MWST an?
    answer: >-
      Die Anmeldung läuft online über das Portal der ESTV (estv.admin.ch). Du brauchst: UID-Nummer deiner Firma, Angaben zur Geschäftstätigkeit und eine Schätzung des Jahresumsatzes. Nach der Anmeldung erhältst du deine MWST-Nummer (CHE-xxx.xxx.xxx MWST) innerhalb weniger Tage.
---

# MWST-Pflicht Schweiz: Ab wann bist du dabei?
...
**Vorteil: Vorsteuer zurückholen**
Wenn du hohe Ausgaben mit MWST hast (teure Maschinen, Equipment, Büromaterial), kannst du die bezahlte MWST als Vorsteuer zurückfordern.
...
**Nachteil: Mehr Administration**
Quartalsweise Abrechnung, MWST auf Rechnungen ausweisen, Buchhaltung aufwändiger.

**Fazit zur freiwilligen Anmeldung:**
Lohnt sich wenn du mehr Vorsteuer zurückholst als du MWST abführst. Oder wenn deine Kunden Unternehmen sind (B2B) — die können die MWST selbst abziehen, also stört sie der höhere Rechnungsbetrag nicht.
...
1. Gehe auf estv.admin.ch
2. Wähle "MWST-Registrierung"
3. Fülle das Formular aus (UID, Tätigkeitsbeschreibung, Umsatzschätzung)
4. Abschicken

### Schritt 3: Bestätigung abwarten

Innerhalb weniger Tage erhältst du deine MWST-Nummer per Post:
...
**Vorteil:** Du holst alle Vorsteuern zurück.
**Nachteil:** Mehr Buchhaltungsaufwand.
...
**Vorteil:** Viel einfacher. Weniger Aufwand.
**Nachteil:** Du holst keine Vorsteuer zurück. Kann teurer sein.
...
**Gute Buchhaltungssoftware** macht das fast automatisch. [Bexio](/artikel/bexio-preise-kosten-erfahrungen), [Klara](/artikel/buchhaltungssoftware-vergleich) und andere generieren die MWST-Abrechnung mit einem Klick.

## Häufige Fehler bei der MWST

**Fehler 1: Anmeldung vergessen**
Du überschreitest die CHF 100'000-Grenze aber meldest dich nicht an. Die ESTV prüft regelmässig und kann rückwirkend Nachforderungen stellen — inklusive Verzugszinsen.

**Fehler 2: Falschen Satz anwenden**
Du verrechnest 8.1% auf Leistungen, die 2.6% oder 0% unterliegen — oder umgekehrt. Das muss bei der Abrechnung korrigiert werden.

**Fehler 3: Auf ausländische Kunden vergessen**
Verkaufst du Dienstleistungen ins Ausland? Dann kann trotzdem Schweizer MWST fällig sein — das hängt vom Ort der Leistungserbringung ab. Bei Unsicherheit: Treuhänder fragen.

**Fehler 4: Vorsteuer auf private Ausgaben abziehen**
Nur Ausgaben für das Geschäft berechtigen zum Vorsteuerabzug. Private Ausgaben nie als Vorsteuer geltend machen.

**Fehler 5: MWST nicht auf Rechnung angeben**
Als MWST-Registrierter muss deine MWST-Nummer auf jeder Rechnung stehen. Auch der MWST-Betrag und der Steuersatz müssen ausgewiesen sein.
...
- [MWST für Selbständige: Alles was du wissen musst](/artikel/mwst-selbstaendige)
- [MWST-Anmeldung Schweiz: Schritt für Schritt](/artikel/mwst-anmeldung-schweiz)
- [Steuern für Selbständige in der Schweiz](/artikel/steuern-selbststaendige)
