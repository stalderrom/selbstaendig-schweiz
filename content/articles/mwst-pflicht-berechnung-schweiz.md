...
keywords:
  ...
  - mwst pflicht grenze schweiz
  - ab wann mwst pflicht schweiz
  - mwst registrierung schweiz selbständige
  - mehrwertsteuer pflicht 2026 schweiz
category: steuern
author: Redaktion
publishedAt: '2026-03-28'
slug: mwst-pflicht-berechnung-schweiz
faq:
  - question: Ab wann bin ich MWST-pflichtig in der Schweiz?
    answer: >-
      Du bist MWST-pflichtig, wenn dein steuerbarer Jahresumsatz CHF 100'000 übersteigt (Art. 10
      MWSTG). Massgeblich ist der weltweite Umsatz aus steuerbaren Leistungen – nicht nur
      Schweizer Kunden. Ausnahme: Bestimmte Leistungen sind von der MWST befreit (Ärzte,
      Bildung, Sozialbereich). Bei Neugründung: Wenn du in den ersten 12 Monaten CHF 100'000
      Umsatz übersteigen wirst, musst du dich vor dem ersten Umsatz anmelden.
  - question: Wie berechne ich, ob ich MWST-pflichtig bin?
    answer: >-
      Massgeblicher Umsatz = alle steuerbaren Leistungen (Verkauf von Waren, Erbringung von
      Dienstleistungen in der Schweiz) innerhalb eines Jahres. Nicht mitzählen: steuerbefreite
      Leistungen (z.B. Arztleistungen), Leistungen im Ausland wenn der Ort der Leistung
      ausserhalb der Schweiz liegt. Beispiel: Freiberufler mit CHF 95'000 Umsatz aus Beratung
      + CHF 15'000 aus Software = CHF 110'000 → MWST-pflichtig.
  - question: Was passiert, wenn ich mich nicht für die MWST anmelde, obwohl ich pflichtig bin?
    answer: >-
      Die ESTV kann rückwirkend MWST plus Verzugszinsen (5% p.a.) einfordern. Die MWST wird
      dann aus dem erhaltenen Betrag herausgerechnet (bei 8.1%: CHF 100'000 brutto =
      CHF 92'508 netto + CHF 7'492 MWST). Du trägst die Steuer aus eigenem Pocket. Zusätzlich
      drohen Bussen. Melde dich daher proaktiv an, sobald du die CHF 100'000 absehbar überschreitest.
  - question: Lohnt sich die freiwillige MWST-Registrierung unter CHF 100'000?
    answer: >-
      Ja, wenn: (1) Deine Kunden grösstenteils Unternehmen sind (können Vorsteuer abziehen –
      kein Nachteil für sie). (2) Du selbst hohe vorsteuerbelastete Investitionen hast
      (Maschinen, IT, Büroeinrichtung). (3) Du exportierst (Exportleistungen sind
      nullsteuerpflichtig – Vorsteuerrückforderung möglich). Nein, wenn: Deine Kunden
      überwiegend Privatkunden sind, die die MWST nicht zurückfordern können.
---

# MWST Pflicht Schweiz 2026: Ab wann bist du steuerpflichtig?
...
1. **Online** via [www.estv.admin.ch](https://www.estv.admin.ch) (Bereich MWST)
...
**Vorteil:** Einfacher, empfohlen wenn Kunden rasch zahlen
**Nachteil:** Du zahlst MWST bevor du das Geld hast
...
**Nachteil:** Mehr administrativer Aufwand, nur auf Antrag bei der ESTV möglich
...
**Praktische Empfehlung:** Verwende [Bexio](/go/bexio) oder eine andere Schweizer Buchhaltungssoftware, die die MWST-Abrechnung automatisch erstellt. Das spart Fehler und Zeit.

Weiterführende Artikel:
- [MWST für Selbständige Schweiz](/artikel/mwst-selbststaendige)
